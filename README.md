...
![](https://github.com/darrida/darrida-fastpages/workflows/CI/badge.svg)
![](https://github.com/darrida/darrida-fastpages/workflows/GH-Pages%20Status/badge.svg)
...
1.  Generate a copy of this repo by clicking [on this link](https://github.com/darrida/darrida-fastpages/generate).  Name your repo anything you like **except** {your-username}.github.io.
...
Adding footnotes in notebooks is a bit different than markdown.  Please see the [Detailed Guide To Footnotes in Notebooks](https://github.com/darrida/darrida-fastpages/blob/master/_fastpages_docs/NOTEBOOK_FOOTNOTES.md).
...
If you already have sufficient familiarity with [Jekyll](https://jekyllrb.com/) and wish to use this automation in your own theme,  you can use this GitHub Action by referencing `darrida/darrida-fastpages@master` as follows:

```yaml
...

uses: darrida/darrida-fastpages@master
...
Please see the [troubleshooting guide](https://github.com/darrida/darrida-fastpages/blob/master/_fastpages_docs/TROUBLESHOOTING.md).
